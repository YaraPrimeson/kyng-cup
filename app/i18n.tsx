...
const common = {
  en: { home: "Home", tennis: "Tennis", padel: "Padel", bracket: "Live bracket", language: "Language", back: "Back to home", openBracket: "Open tournament bracket", participate: "Request a place", joinWaitlist: "Join waitlist", registrationClosed: "Registration closed", noTournament: "The next tournament will be announced soon.", loadingTournament: "Loading the next tournament…", upcoming: "Upcoming tournament", location: "Location", pairs: "Pairs", status: "Status", scheduled: "Scheduled", live: "Live", completed: "Completed", viewBracket: "View live bracket", contact: "Contact", copyright: "International Padel Community" },
  uk: { home: "Головна", tennis: "Теніс", padel: "Падел", bracket: "Сітка турніру", language: "Мова", back: "На головну", openBracket: "Відкрити турнірну сітку", participate: "Подати заявку", joinWaitlist: "До листа очікування", registrationClosed: "Реєстрацію закрито", noTournament: "Наступний турнір буде оголошено незабаром.", loadingTournament: "Завантажуємо наступний турнір…", upcoming: "Найближчий турнір", location: "Локація", pairs: "Пари", status: "Статус", scheduled: "Заплановано", live: "Наживо", completed: "Завершено", viewBracket: "Дивитися сітку", contact: "Контакти", copyright: "Міжнародна падел-спільнота" },
  de: { home: "Startseite", tennis: "Tennis", padel: "Padel", bracket: "Turnierbaum", language: "Sprache", back: "Zur Startseite", openBracket: "Turnierbaum öffnen", participate: "Teilnahme anfragen", joinWaitlist: "Auf die Warteliste", registrationClosed: "Anmeldung geschlossen", noTournament: "Das nächste Turnier wird bald angekündigt.", loadingTournament: "Nächstes Turnier wird geladen…", upcoming: "Nächstes Turnier", location: "Ort", pairs: "Paare", status: "Status", scheduled: "Geplant", live: "Live", completed: "Beendet", viewBracket: "Turnierbaum ansehen", contact: "Kontakt", copyright: "Internationale Padel-Community" },
  ru: { home: "Главная", tennis: "Теннис", padel: "Падел", bracket: "Турнирная сетка", language: "Язык", back: "На главную", openBracket: "Открыть турнирную сетку", participate: "Подать заявку", joinWaitlist: "В лист ожидания", registrationClosed: "Регистрация закрыта", noTournament: "Следующий турнир будет объявлен в ближайшее время.", loadingTournament: "Загружаем следующий турнир…", upcoming: "Ближайший турнир", location: "Локация", pairs: "Пары", status: "Статус", scheduled: "Запланирован", live: "В эфире", completed: "Завершён", viewBracket: "Смотреть сетку", contact: "Контакты", copyright: "Международное падел-сообщество" },
} as const;
...
const autoTranslations: Record<string, Partial<Record<Exclude<Language, "en">, string>>> = {
  ...
  "Registrations": { uk: "Заявки", de: "Anmeldungen", ru: "Заявки" },
  "Review pair applications and keep each status up to date.": { uk: "Переглядайте заявки пар і підтримуйте їхні статуси актуальними.", de: "Prüfen Sie Paaranmeldungen und halten Sie jeden Status aktuell.", ru: "Просматривайте заявки пар и поддерживайте их статусы актуальными." },
  "Filter by status": { uk: "Фільтр за статусом", de: "Nach Status filtern", ru: "Фильтр по статусу" },
  "All applications": { uk: "Усі заявки", de: "Alle Anmeldungen", ru: "Все заявки" },
  "New": { uk: "Нова", de: "Neu", ru: "Новая" },
  "Reviewing": { uk: "На розгляді", de: "In Prüfung", ru: "На рассмотрении" },
  "Confirmed": { uk: "Підтверджена", de: "Bestätigt", ru: "Подтверждена" },
  "Waitlist": { uk: "Лист очікування", de: "Warteliste", ru: "Лист ожидания" },
  "Rejected": { uk: "Відхилена", de: "Abgelehnt", ru: "Отклонена" },
  "Refresh applications": { uk: "Оновити заявки", de: "Anmeldungen aktualisieren", ru: "Обновить заявки" },
  "No applications match this filter.": { uk: "Немає заявок, що відповідають цьому фільтру.", de: "Keine Anmeldungen entsprechen diesem Filter.", ru: "Нет заявок, соответствующих этому фильтру." },
  "Loading applications failed.": { uk: "Не вдалося завантажити заявки.", de: "Anmeldungen konnten nicht geladen werden.", ru: "Не удалось загрузить заявки." },
  "Pair application": { uk: "Заявка пари", de: "Paaranmeldung", ru: "Заявка пары" },
  "Player 1": { uk: "Гравець 1", de: "Spieler 1", ru: "Игрок 1" },
  "Player 2": { uk: "Гравець 2", de: "Spieler 2", ru: "Игрок 2" },
  "Messenger": { uk: "Месенджер", de: "Messenger", ru: "Мессенджер" },
  "Playing level": { uk: "Рівень гри", de: "Spielniveau", ru: "Уровень игры" },
  "Rating": { uk: "Рейтинг", de: "Rating", ru: "Рейтинг" },
  "Submitted": { uk: "Подано", de: "Eingereicht", ru: "Подана" },
  "Language": { uk: "Мова", de: "Sprache", ru: "Язык" },
  "News opt-in": { uk: "Згода на новини", de: "News-Einwilligung", ru: "Согласие на новости" },
  "Yes": { uk: "Так", de: "Ja", ru: "Да" },
  "No": { uk: "Ні", de: "Nein", ru: "Нет" },
  "Applicant message": { uk: "Повідомлення заявника", de: "Nachricht der Bewerber", ru: "Сообщение заявителя" },
  "Admin notes": { uk: "Нотатки адміністратора", de: "Admin-Notizen", ru: "Заметки администратора" },
  "Private note for the tournament team": { uk: "Приватна нотатка для команди турніру", de: "Private Notiz für das Turnierteam", ru: "Приватная заметка для команды турнира" },
  "Save application": { uk: "Зберегти заявку", de: "Anmeldung speichern", ru: "Сохранить заявку" },
  "Registration updated.": { uk: "Заявку оновлено.", de: "Anmeldung aktualisiert.", ru: "Заявка обновлена." },
  ...
  "Edit the pair and player names used in the tournament bracket.": { uk: "Редагуйте назви пар та імена гравців у турнірній сітці.", de: "Bearbeiten Sie Paar- und Spielernamen für den Turnierbaum.", ru: "Редактируйте названия пар и имена игроков в турнирной сетке." },
  ...
  "Registration": { uk: "Реєстрація", de: "Anmeldung", ru: "Регистрация" },
  "Open · accepting pairs": { uk: "Відкрито · приймаємо пари", de: "Geöffnet · Paare werden angenommen", ru: "Открыта · принимаем пары" },
  "Waitlist only": { uk: "Лише лист очікування", de: "Nur Warteliste", ru: "Только лист ожидания" },
  "Closed": { uk: "Закрито", de: "Geschlossen", ru: "Закрыта" },
  "Draft · hidden": { uk: "Чернетка · приховано", de: "Entwurf · verborgen", ru: "Черновик · скрыт" },
  "Published · show on sport page": { uk: "Опубліковано · показувати на сторінці спорту", de: "Veröffentlicht · auf Sportseite anzeigen", ru: "Опубликован · показывать на странице спорта" },
  ...
  "Tournament created and published on the relevant sport page.": { uk: "Турнір створено й опубліковано на відповідній сторінці спорту.", de: "Turnier erstellt und auf der entsprechenden Sportseite veröffentlicht.", ru: "Турнир создан и опубликован на соответствующей странице спорта." },
  "Draft tournament created.": { uk: "Чернетку турніру створено.", de: "Turnierentwurf erstellt.", ru: "Черновик турнира создан." },
