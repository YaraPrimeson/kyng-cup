...
const common = {
  ...
  de: { home: "Startseite", tennis: "Tennis", padel: "Padel", bracket: "Turnierbaum", language: "Sprache", back: "Zur Startseite", openBracket: "Turnierbaum öffnen", participate: "Teilnahme anfragen", joinWaitlist: "Auf die Warteliste", registrationClosed: "Anmeldung geschlossen", noTournament: "Das nächste Turnier wird bald angekündigt.", loadingTournament: "Nächstes Turnier wird geladen…", upcoming: "Nächstes Turnier", location: "Ort", pairs: "Paare", status: "Status", scheduled: "Geplant", live: "Live", completed: "Beendet", viewBracket: "Turnierbaum ansehen", contact: "Kontakt", copyright: "Internationale Tennis- & Padel-Community" },
  ru: { home: "Главная", tennis: "Теннис", padel: "Падел", bracket: "Турнирная сетка", language: "Язык", back: "На главную", openBracket: "Открыть турнирную сетку", participate: "Подать заявку", joinWaitlist: "В лист ожидания", registrationClosed: "Регистрация закрыта", noTournament: "Следующий турнир будет объявлен в ближайшее время.", loadingTournament: "Загружаем следующий турнир…", upcoming: "Ближайший турнир", location: "Локация", pairs: "Пары", status: "Статус", scheduled: "Запланирован", live: "В эфире", completed: "Завершён", viewBracket: "Смотреть сетку", contact: "Контакты", copyright: "Международное сообщество тенниса и падела" },
} as const;
