...
const common = {
  en: { home: "Home", tennis: "Tennis", padel: "Padel", bracket: "Live bracket", language: "Language", back: "Back to home", openBracket: "Open tournament bracket", participate: "Request a place", noTournament: "The next tournament will be announced soon.", loadingTournament: "Loading the next tournament…", upcoming: "Upcoming tournament", location: "Location", pairs: "Pairs", status: "Status", scheduled: "Scheduled", live: "Live", completed: "Completed", viewBracket: "View live bracket", contact: "Contact", copyright: "International tennis & padel community" },
  uk: { home: "Головна", tennis: "Теніс", padel: "Падел", bracket: "Сітка турніру", language: "Мова", back: "На головну", openBracket: "Відкрити турнірну сітку", participate: "Подати заявку", noTournament: "Наступний турнір буде оголошено незабаром.", loadingTournament: "Завантажуємо наступний турнір…", upcoming: "Найближчий турнір", location: "Локація", pairs: "Пари", status: "Статус", scheduled: "Заплановано", live: "Наживо", completed: "Завершено", viewBracket: "Дивитися сітку", contact: "Контакти", copyright: "Міжнародна тенісна та падел-спільнота" },
  de: { home: "Startseite", tennis: "Tennis", padel: "Padel", bracket: "Turnierbaum", language: "Sprache", back: "Zur Startseite", openBracket: "Turnierbaum öffnen", participate: "Teilnahme anfragen", noTournament: "Das nächste Turnier wird bald angekündigt.", loadingTournament: "Nächstes Turnier wird geladen…", upcoming: "Nächstes Turnier", location: "Ort", pairs: "Paare", status: "Status", scheduled: "Geplant", live: "Live", completed: "Beendet", viewBracket: "Turnierbaum ansehen", contact: "Kontakt", copyright: "Internationale Tennis- & Padel-Community" },
  ru: { home: "Главная", tennis: "Теннис", padel: "Падел", bracket: "Турнирная сетка", language: "Язык", back: "На главную", openBracket: "Открыть турнирную сетку", participate: "Подать заявку", noTournament: "Следующий турнир будет объявлен в ближайшее время.", loadingTournament: "Загружаем следующий турнир…", upcoming: "Ближайший турнир", location: "Локация", pairs: "Пары", status: "Статус", scheduled: "Запланирован", live: "В эфире", completed: "Завершён", viewBracket: "Смотреть сетку", contact: "Контакты", copyright: "Международное сообщество тенниса и падела" },
} as const;
